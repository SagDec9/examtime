...
exams[25] = {
  ...
  schedule() {
    $("早读", today.date, "07:30", "08:00");
    $("第1节", today.date, "08:10", "09:00");
    $("第2节", today.date, "09:10", "10:00");
    $("第3节", today.date, "10:10", "11:00");
    $("第4节", today.date, "11:10", "12:00");
    $("第5节", today.date, "14:25", "15:05");
    $("第6节", today.date, "15:20", "16:00");
    $("自习", today.date, "16:10", "16:50");
    $("课间活动", today.date, "16:50", "17:15");
    $("自习", today.date, "17:15", "18:00");
    $("自习", today.date, "19:00", "20:10");
    $("自习", today.date, "20:20", "21:30");
    $("自习", today.date, "21:40", "22:30");
  }
};
...
exams[263] = {
  ...
  schedule() {
    ...
    $("自习", today.date, "19:00", "20:10");
    $("自习", today.date, "20:20", "21:20");
    $("自习", today.date, "21:30", "22:30");
      }
};
...
exams[262] = {
  ...
  rollSlogan: ["自立·自治·自觉·自动"],
  schedule() {
    $("早读", today.date, "07:00", "07:30");
    $("第1节", today.date, "07:40", "08:20");
    $("第2节", today.date, "08:30", "09:10");
    $("第3节", today.date, "09:20", "10:00");
    $("课间操", today.date, "10:00", "10:30");
    $("第4节", today.date, "10:30", "11:10");
    $("第5节", today.date, "11:20", "12:00");
    $("第6节", today.date, "14:45", "15:25");
    $("第7节", today.date, "15:40", "16:20");
    $("第8节", today.date, "16:30", "17:10");
    $("自习", today.date, "17:20", "18:00");
    $("自习", today.date, "19:00", "20:30");
    $("自习", today.date, "20:40", "21:50");
    $("自习", today.date, "21:00", "23:00");
  }
};
